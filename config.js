window.AppConfig = {
    ...
    API_ENDPOINTS: {
        ...
        // ================ 话题模块（需Token） ================
        CREATE_TOPIC: '/topics',  // 创建话题
        GET_TOPICS: '/topics',  // 获取话题列表（需要taskId参数）
        GET_TOPIC_DETAIL: '/topics/{id}',  // 获取话题详情
        UPDATE_TOPIC: '/topics/{id}',  // 更新话题
        DELETE_TOPIC: '/topics/{id}',  // 删除话题
        GET_TOPIC_COMMENTS: '/topics/{topicId}/comments',  // 获取话题评论列表
        CREATE_TOPIC_COMMENT: '/topics/{topicId}/comments',  // 创建话题评论
    ...
    STORAGE_KEYS: {
        ...
        VIDEO_COMMENTS: 'teacher_video_club_video_comments',  // 视频评论缓存
        AI_CHAT_HISTORY: 'teacher_video_club_ai_chat_history',  // AI聊天历史
        AI_CONVERSATION_ID: 'teacher_video_club_ai_conversation_id'  // AI会话ID
    },
    ...
    PAGE_PATHS: {
        ...
        VIDEO_PLAYER: 'pages/video-player.html',  // 视频播放页面
        'VIDEO-PLAYER': 'pages/video-player.html',  // 兼容连字符格式
        TOPIC_LIST: 'pages/topiclist.html',  // 话题列表页面
        'TOPICLIST': 'pages/topiclist.html',  // 兼容连字符格式
        TOPIC_FORUM: 'pages/topicforum.html',  // 话题论坛页面
        'TOPICFORUM': 'pages/topicforum.html'  // 兼容连字符格式
    },
    ...
    FIXED_TASKS: {
        WATCH_TASK: {
            ...
            platformName: "教学视频平台"  // 修改为更通用的名称，避免特指某个平台
        },
        RESEARCH_TASK: {
            id: 2,
            title: "教学研讨笔记",
    ...
    AI_CONFIG: {
        ...
        // 聊天窗口位置
        CHAT_WINDOW_POSITION: 'bottom-right',
        // AI图标大小
        ICON_SIZE: '60px',
        // 聊天窗口尺寸
        WINDOW_WIDTH: '400px',
        WINDOW_HEIGHT: '600px',
        // 欢迎消息
        WELCOME_MESSAGE: '你好！我是AI教学助手，有什么可以帮助你的吗？'
    }
};
